...
function DefaultContainer() {
  useDataUpdates();
  const tree = useTreeApi();
  return (0, import_jsx_runtime12.jsx)("div", { role: "tree", "aria-label": tree.props["aria-label"], "aria-labelledby": tree.props["aria-labelledby"], "aria-multiselectable": !tree.props.disableMultiSelection || void 0, style: {
    height: tree.height,
    width: tree.width,
    minHeight: 0,
    minWidth: 0
...
function List() {
  ...
  const commonProps = {
    ...
    itemKey: (index) => {
      var _a2;
      return ((_a2 = tree.visibleNodes[index]) === null || _a2 === void 0 ? void 0 : _a2.id) || index;
    },
  ...
  if (typeof tree.props.rowHeight === "function") {
    return (
      // @ts-ignore
      (0, import_jsx_runtime12.jsx)(VariableSizeList, Object.assign({}, commonProps, { itemSize: tree.rowHeightAt, ref: tree.list, children: RowContainer }))
    );
  }
  return (
    // @ts-ignore
    (0, import_jsx_runtime12.jsx)(FixedSizeList, Object.assign({}, commonProps, { itemSize: tree.rowHeight, ref: tree.list, children: RowContainer }))
  );
}
...
var { safeRun: safeRun2 } = utils_exports;
var TreeApi = class _TreeApi {
  constructor(store, props, list, listEl) {
    ...
    this.redrawList = (afterIndex = 0) => {
      this.rowOffsets = null;
      const list2 = this.list.current;
      if (list2 && "resetAfterIndex" in list2) {
        list2.resetAfterIndex(Math.max(0, afterIndex));
      }
    };
  ...
  delete(node) {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      const fromIndex = nodes.length ? Math.min(...nodes.map((n) => {
        var _a;
        return (_a = n.rowIndex) !== null && _a !== void 0 ? _a : 0;
      })) : 0;
  ...
  filterSelectableNodes(nodes) {
    return nodes.map((n) => this.get(this.identify(n))).filter((n) => !!n && n.isSelectable);
  }
  setSelection(args) {
    var _a;
...
var SimpleTree = class {
  constructor(data, options = {}) {
    ...
    this.root = createRoot2(data, this.accessors);
  }
  get data() {
    var _a, _b;
...
function createRoot2(data, accessors) {
...
function useSimpleTree(initialData, options = {}) {
  ...
  const tree = (0, import_react33.useMemo)(() => new SimpleTree(data, { idAccessor, childrenAccessor }), [data, idAccessor, childrenAccessor]);
  const onMove = (args) => {
  ...
  const onCreate = ({ parentId, index, type }) => {
    ...
    const data2 = { [idKey]: `simple-tree-id-${nextId++}`, name: "" };
    if (type === "internal")
      data2[childrenKey] = [];
