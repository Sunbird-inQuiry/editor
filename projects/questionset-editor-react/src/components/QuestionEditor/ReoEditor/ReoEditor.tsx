...
import styles from './ReoEditor.module.scss';

export default function ReoEditor() {
  ...
  return (
    <div className={styles.container}>
      <p className={styles.header}>
        Define the correct order. Users will see these shuffled.
      </p>
      ...
      <div className={styles.itemsList}>
        {sequence.map((item, idx) => (
          <div key={idx} className={styles.itemRow}>
            {/* Drag handle (visual — manual reorder via buttons) */}
